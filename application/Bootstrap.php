...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
    ...
    protected function _initPlaceholders() {
        ...
        $view->headLink()->appendStylesheet('/ZendProject/public/css/animate.css');
     //   $view->headLink()->appendStylesheet('/ZendProject/public/css/queryLoader.css');
        $view->headLink()->appendStylesheet('/ZendProject/public/css/superslides.css');
       // $view->headLink()->appendStylesheet('/ZendProject/public/css/slick.css');
        
        
        $view->headLink()->appendStylesheet('/ZendProject/public/css/jquery.tosrus.all.css');
        $view->headLink()->appendStylesheet('/ZendProject/public/css/themes/default-theme.css');
        $view->headLink()->appendStylesheet('/ZendProject/public/css/style.css');
        ...
        $view->headScript()->appendFile('/ZendProject/public/js/wow.min.js');
        $view->headScript()->appendFile('/ZendProject/public/js/slick.min.js');
        $view->headScript()->appendFile('/ZendProject/public/js/jquery.tosrus.min.all.js');
        $view->headScript()->appendFile('/ZendProject/public/js/custom.js');
        $view->headScript()->appendFile('/ZendProject/public/js/jquery.easing.1.3.js');
        $view->headScript()->appendFile('/ZendProject/public/js/jquery.animate-enhanced.min.js');
        $view->headScript()->appendFile('/ZendProject/public/js/jquery.superslides.min.js');
